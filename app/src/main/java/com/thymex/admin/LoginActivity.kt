...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tab.addTab(tab.newTab().setText("Login for Admin only"))
        tab.addTab(tab.newTab().setText("Employees Registration"))
        tab.tabGravity=TabLayout.GRAVITY_FILL
        val viewpageAdapter=viewPAGERadapter(supportFragmentManager)
        viewpageAdapter.addFragment(Login(),"Login for Admin only")
        viewpageAdapter.addFragment(signup_fragment(),"Employees Registration")
